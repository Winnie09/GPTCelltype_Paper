library(data.table)
d <- fread('/Users/zhichengji/Dropbox/research/gptcelltype/simu/gpt4aug3/res/subset.csv',data.table=F)
...
d <- d[,c('simuround','subset','gene',cn)]

write.csv(d,file='/Users/zhichengji/Dropbox/research/gptcelltype/simu/gpt4aug3/compiled/subset.csv',row.names=F)
